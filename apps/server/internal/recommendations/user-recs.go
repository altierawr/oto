...
func (s *Service) updateSingleUserRecommendations(ctx context.Context, user data.User) error {
	...
	s.updateSingleUserRecommendedTracks(ctx, user, topTracks)

	return nil
}

func (s *Service) updateSingleUserRecommendedTracks(ctx context.Context, user data.User, topTracks *[]types.TidalSong) error {
