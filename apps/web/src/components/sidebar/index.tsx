...
const Sidebar = () => {
  ...
  return (
    <div className="h-full min-w-(--sidebar-width) w-(--sidebar-width) py-4 px-2 flex flex-col justify-between border-r border-r-(--gray-3)">
      <Link to="/" className="flex items-center px-3 gap-3 no-underline!">
        <img src={"/logo-64.png"} width="20" height="20" />
        <p className="font-medium text-2xl">oto</p>
      </Link>
